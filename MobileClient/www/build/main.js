        ...
        new Promise(function (resolve) {
            ...
            setTimeout(function () {
                new Promise(function (resolve) {
                    ...
                    //EMIT SERVED
                    _this.realTimeProvider.emitServed([_this.actualPos.lat, _this.actualPos.lon]);
                    _this.markers.push(auxMarker);
                    _this.truck.clientsAtended++;
                    _this.truckProvider.update(_this.truck);
                    if (_this.clientsToServe.length == 1) {
                        _this.end = false;
                    }
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"C:\Users\A680127\Desktop\TFGv2\MobileClient\src\app\app.html"*/'<!-- <ion-header>\n\n    <ion-navbar>\n\n        <ion-title>\n\n            Sistema de gestión de transporte\n\n        </ion-title>\n\n    </ion-navbar>\n\n</ion-header> -->\n\n<ion-content>\n\n    <ion-nav [root]="rootPage"></ion-nav>\n\n</ion-content>'/*ion-inline-end:"C:\Users\A680127\Desktop\TFGv2\MobileClient\src\app\app.html"*/
        }),
